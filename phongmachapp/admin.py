...
admin.add_view(UnitView(Unit, db.session,name="Quản lý đơn vị",category="Thuốc"))
admin.add_view(MedicineView(Medicine, db.session,name="Quản lý thuốc",category="Thuốc"))
admin.add_view(MedicalExaminationFormView(MedicalExaminationForm, db.session,name="Phiếu khám bệnh",category="Phiếu khám bệnh"))
admin.add_view(MedicalExaminationFormDetailView(MedicalExaminationFormDetail, db.session,name="Chi tiết phiếu khám bệnh",category="Phiếu khám bệnh"))
admin.add_view(PatientListDetailView(PatientListDetail, db.session,name="Chi tiet Danh sách khám",category="Danh sách khám"))
admin.add_view(PatientListView(PatientList, db.session,name="danh sách khám",category="Danh sách khám"))
admin.add_view(PaymentInvoiceView(PaymentInvoice, db.session,name="Hóa đơn"))
admin.add_view(MonthlyRevenueView(name="Thống kê doanh thu theo tháng",category="Thống kê"))
admin.add_view(MonthlyMedicineView(name="Thống kê sử dụng thuốc theo tháng",category="Thống kê"))
